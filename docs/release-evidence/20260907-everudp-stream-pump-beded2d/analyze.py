...
SHA = "beded2d447eb055099fb992eaf7d30ea9ef8e7f7"
TREE = "2022d0738cd07d1506179134ef5f8fe0b866199f"
...
for role, build in builds.items():
    ...
    assert build["everudp_build"]["cargo_features"] == (
        ["cli"] if role == "baseline" else ["cli", "stream-pump-spike"])
...
for loss in (0, 5):
    ...
    rng = random.Random(1111700 + loss)
