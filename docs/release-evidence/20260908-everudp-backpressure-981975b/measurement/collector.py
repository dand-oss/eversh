"""Bounded client-backpressure measurement, explicitly not release qualification."""
...
OUT = Path("/tmp/everudp-backpressure-comparison-981975b")
SOURCE = {"head_sha": "981975bceed8a315b3c827406dc8c5be029ec272",
          "tree_sha": "04c8012f84efb6fd0e2e7d98cf967feaba4dc9df"}
NAMES = ("everudp", "zmosh-udp", "zmosh-quic")
SEEDS = (18000001, 18000002, 18050001, 18050002)
...
receipt = {"schema_version": 1, "purpose": "client-backpressure-fix",
