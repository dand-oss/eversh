    ...
    def test_build_provenance_binds_exact_source_and_artifact_bytes(self) -> None:
        with tempfile.TemporaryDirectory() as raw:
            ...
            inputs = {
                ...
                "zmosh_transcript_source": repository / "spikes/everudp/net/zmosh-transcript.c",
                "zmosh_transcript_header": repository / "spikes/everudp/net/zmosh-transcript.h",
                "pty_echo_source": repository / "spikes/everudp/net/pty-echo.c",
            }
